...
SECRET_KEY = 'django-insecure-9h0h_z*%0gg@rb$c9%f+sa4=51^wmi3y77&)7^pqcu+(i&ed-!'
...
LANGUAGE_CODE = 'ru'  # язык админ панели
...
STATIC_URL = '/static/'  # префикс URL для статических ф-ов
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # путь к общей статической папке,
# используемой реальным веб-сервером
STATICFILES_DIRS = []
"""список дополнительных(нестандар, лежащих в др папках) путей к статическим ф-ам,
используемых для сбора и отладки"""
# Default primary key field type
# https://docs.djangoproject.com/en/4.1/ref/settings/#default-auto-field

DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'

# для автоматической загрузки файлов и формирования пути
